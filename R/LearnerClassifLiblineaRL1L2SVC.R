#' @title L1-Regularized L2-Loss Support Vector Classification
#'
#' @aliases mlr_learners_classif.liblinearl1l2svc
#' @format [R6::R6Class] inheriting from [mlr3::LearnerClassif].
#'
#' @description
#' A [mlr3::LearnerClassif] for a L1-Regularized L2-Loss Support Vector Classification implemented in [LiblineaR::LiblineaR()] in package \CRANpkg{LiblineaR}.
#'
#' @export
LearnerClassifLiblineaRL1L2SVC = R6Class("LearnerClassifLiblineaRL1L2SVC", inherit = LearnerClassif,
  public = list(
   initialize = function() {
     ps = ParamSet$new(
       params = list(
